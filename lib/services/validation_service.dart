// lib/services/validation_service.dart (VERSÃO MODIFICADA)
...
class ValidationService {
  ...
  ValidationResult validateParcela(List<Arvore> arvores) {
    // =========================================================================
    // <<< MUDANÇA: FILTRANDO A LISTA PARA ANÁLISE ESTATÍSTICA >>>
    // Apenas árvores que foram efetivamente medidas (não são falhas/caídas)
    // entram no cálculo de média e desvio padrão.
    ...
    // Usa a lista filtrada para todos os cálculos
    ...
    // Itera sobre a lista filtrada para encontrar outliers
