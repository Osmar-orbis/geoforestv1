// lib/pages/cubagem/cubagem_dados_page.dart (COPIE E COLE ESTE CÓDIGO COMPLETO)
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(controller: _idFazendaController, decoration: const InputDecoration(labelText: 'ID da Fazenda (Opcional)', border: OutlineInputBorder())),
              const SizedBox(height: 16),
              TextFormField(controller: _fazendaController, decoration: const InputDecoration(labelText: 'Fazenda', border: OutlineInputBorder()), validator: _validadorObrigatorio),
              const SizedBox(height: 16),
              TextFormField(controller: _talhaoController, decoration: const InputDecoration(labelText: 'Talhão', border: OutlineInputBorder()), validator: _validadorObrigatorio),
