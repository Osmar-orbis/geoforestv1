// lib/pages/amostra/lista_coletas_page.dart
...
class _ListaColetasPageState extends State<ListaColetasPage> {
  ...
  // --- Métodos de Navegação e Ações de Item Único (sem alterações) ---
  ...
  // =========================================================================
  // ---> WIDGETS DE CONSTRUÇÃO DOS CARDS COM LÓGICA DE GESTOS CORRIGIDA <---
  // =========================================================================
    ...
    return Card(
      ...
      child: Slidable(
        ...
        child: ListTile(
          onTap: () {
            if (_isSelectionMode) {
              // Se estamos no modo de seleção, um toque curto alterna a seleção.
              _toggleSelection(true, parcela.dbId!);
            } else if (isClickable) {
              // Senão, um toque curto navega para os detalhes.
              _navegarParaInventario(parcela);
            }
          },
          onLongPress: () {
            // Um toque longo sempre inicia/alterna o modo de seleção.
            _toggleSelection(true, parcela.dbId!);
          },
        ...
        child: ListTile(
          onTap: () {
            if (_isSelectionMode) {
              ...
              // Senão, um toque curto edita a cubagem.
          ...
          : SpeedDial(
              ...
              children: [
                ...
                SpeedDialChild(
                  ...
                  onTap: () {
                    final novaParcelaAvulsa = Parcela(nomeFazenda: '', nomeTalhao: '', idParcela: '', areaMetrosQuadrados: 0, status: StatusParcela.pendente, dataColeta: DateTime.now());
