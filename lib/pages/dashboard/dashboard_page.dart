// lib/pages/dashboard_page.dart (VERSÃO COM FILTRO DE KPI E LÓGICA CORRETA)
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  // >>> MUDANÇA 1: A variável agora guarda a lista de mapas <<<
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      ...
      // >>> MUDANÇA 2: A variável recebe a lista de mapas <<<
  ...
  // >>> MUDANÇA 3: A LÓGICA DE CÁLCULO FOI COMPLETAMENTE ATUALIZADA <<<
  void _calculateKPIs() {
    // Calcula o total de fustes, excluindo 'falha' e 'caida'
    _totalFustes = 0;
    ...
    // O total de covas é simplesmente o total de registros
    _totalCovas = _distribuicaoPorCodigo.values.fold(0, (prev, element) => prev + element.toInt());

    // Filtra os valores de CAP para incluir apenas árvores válidas para cálculo (exclui falha, caída e morta)
    ...
    // Agora, todos os KPIs de CAP são calculados APENAS com os valores filtrados
  ...
  // >>> MUDANÇA 4: CARD DE KPIs ATUALIZADO COM AS NOVAS MÉTRICAS <<<
  Widget _buildKPIs() {
    return Card(
      elevation: 2,
      child: Padding(
  ...
  // >>> MUDANÇA 5: O HISTOGRAMA AGORA USA OS DADOS FILTRADOS <<<
